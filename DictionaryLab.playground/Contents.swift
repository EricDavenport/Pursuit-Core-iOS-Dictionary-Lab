...
let calAndDanAppleCount = (applesDict["Dan"] ?? -1) + applesDict["Cal"]!  /* YOur code here */
...
//    if let newValue = applesDict.updateValue(_, forKey: 3) {
//        newValue = 0
//    }
...
authorScores = [String: Double] = ["Mark Twain": 8.9,
                                   "Nathaniel Hawthorne": 5.1,
                                   "John Steinbeck": 2.3,
                                   "C.S. Lewis": 9.9,
                                   "Jon Krakauer": 6.1]
